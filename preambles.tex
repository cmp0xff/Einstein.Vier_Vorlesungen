...
% https://tex.stackexchange.com/questions/214030/
% how-can-i-indent-paragraphs-within-an-itemize-environment
% \usepackage{enumitem}
...
%h ttp://unifraktur.sourceforge.net/
...
% Fraction-like
\newcommand{\frde}[2]{{\dfrac{\dd{#1}}{\dd{#2}}}}
